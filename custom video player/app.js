...
videoTimeline.addEventListener("mouseover",e=>{
    const progresTime=videoTimeline.querySelector("span");
    let offsetX=e.offsetX;
    progresTime.style.left=`${offsetX}px`;
    let timelineWidth=videoTimeline.clientWidth;
    let percent=(e.offsetX/timelineWidth)*mainVideo.duration;
    progresTime.innerText=formatTime(percent);
});
...
speedOptions.querySelectorAll("li").forEach(option=>{
    option.addEventListener("click",()=>{
        mainVideo.playbackRate=option.dataset.speed; //passing option dataset value as play back speed value
